...
&{BOOK_15}    Id=15   # Aqui no &{BOOK_15} são as variaveis com valores fixos que podem ser passadas no test case tbm
...           Title=Book 15    
...           PageCount=1500  
&{BOOK_201}     ID=201
...
Requisitar todos os livros    #${RESPOSTA} = um nome dado ao Get on session
    ...
    Set Test Variable    ${RESPOSTA}    #Aqui defino a variavel teste = RESPOSTA, para ser usada em outras KeyWords
